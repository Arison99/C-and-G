...
========================================= -->
<?php
// Ensure Bootstrap JS is loaded for the carousel
wp_enqueue_script(
...
wp_add_inline_script('bootstrap-carousel-js', "
    document.addEventListener('DOMContentLoaded', function () {
        var servicesCarousel = document.querySelector('#servicesCarousel');
        if (servicesCarousel) {
        ...
        <div class="container-fluid py-5 border" style="background-color: #5c1a4b;">
          <div class="row align-items-center">
            ...
            <div class="col-md-6 text-center img">
              <img
                src="<?php echo get_template_directory_uri(); ?>/assets/images/slide 1.jpg"
      ...
      <div class="carousel-item">
        <div class="container-fluid py-5 border" style="background-color: #5c1a4b;">
          <div class="row align-items-center">
            ...
            <div class="col-md-6 text-center img">
              <img
                src="<?php echo get_template_directory_uri(); ?>/assets/images/slide 2.jpg"
                alt="Elderly Care"
                class="img-fluid rounded-circle img-cd"
      ...
      <div class="carousel-item">
        <div class="container-fluid py-5 border" style="background-color: #5c1a4b;">
          <div class="row align-items-center">
            ...
            <div class="col-md-6 text-center img">
              <img
                src="<?php echo get_template_directory_uri(); ?>/assets/images/slide 8.jpg"
                alt="Home Cleaning"
                class="img-fluid rounded-circle img-cd"
      ...
      <div class="carousel-item">
        <div class="container-fluid py-5 border" style="background-color: #5c1a4b;">
          <div class="row align-items-center">
            ...
            <div class="col-md-6 text-center img">
              <img
                src="<?php echo get_template_directory_uri(); ?>/assets/images/slide 14.jpg"
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-6">
                            <div class="about-image-container">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/elderlycare.jpg" alt="" class="img-fluid about-image">
                            </div>
                        </div>
                    ...
                    <div class="services-carousel">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="service-card">
                                    <div class="service-img-container">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/cook.jpeg" alt="Cooking For Special Events" class="img-fluid service-img">
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="service-card">
                                    <div class="service-img-container">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/caregiving.jpeg" alt="Care Giving" class="img-fluid service-img">
                                    </div>
                                    <div class="service-content">
                            ...
                            <div class="col-md-3">
                                <div class="service-card">
                                    <div class="service-img-container">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/elderlysupport.jpg" alt="Elderly Support" class="img-fluid service-img">
                                    </div>
                                    <div class="service-content">
                            ...
                            <div class="col-md-3">
                                <div class="service-card">
                                    <div class="service-img-container">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/elderlycare.jpg" alt="Child Care Services" class="img-fluid service-img">
                                    </div>
                                    <div class="service-content">
